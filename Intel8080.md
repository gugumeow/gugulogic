...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
|**0**|00h|01h|02h|03h|04h|05h|06h|07h|08h|09h|0Ah|0Bh|0Ch|0Dh|0E(MVI C,data)|0Fh|
...
| `0x0006`   | `DCR C`       | `0D`        | C = C - 1 (因為 Fib(1) 已知)   |
| `0x0007`   | `JZ DONE`     | `CA 10 20`  | 若 C == 0，跳轉到 DONE         |
| `0x000A`   | `MOV H, A`    | `67`        | H = A (暫存 Fib(n))            |
| `0x000B`   | `ADD B`       | `80`        | A = A + B (計算 Fib(n))        |
| `0x000C`   | `MOV B, H`    | `44`        | B = H (更新 Fib(n-1))          |
| `0x000D`   | `DCR C`       | `0D`        | C = C - 1                       |
| `0x000E`   | `JMP LOOP`    | `C3 07 20`  | 跳回 LOOP (繼續計算)           |
| `0x0010`   | `DONE:`       |             | 標籤 `DONE` (計算結束)         |
| `0x0011`   | `HLT`         | `76`        | 停止執行                       |
